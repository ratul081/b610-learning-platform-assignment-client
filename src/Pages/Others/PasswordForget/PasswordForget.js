...
const PasswordForget = () => {
  ...
  const handlePasswordRest = (event) => {
    ...
    console.log("🚀 ~ file: LogIn.js:45 ~ handlePasswordRest ~ email:", email)
    passwordReset(email)
      .then(() => {
  ...
  return (
    <div className='grid place-items-center min-h-screen bg-base-200'>
      <form onSubmit={handlePasswordRest}>
        <p className='text-2xl text-center my-6'>Enter the email address associated  with your account <br /> and we'll send you a link to reset your password</p>
