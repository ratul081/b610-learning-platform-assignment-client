    ...
    <div className='text-center m-12 space-y-6 min-h-screen'>
      ...
      <div className='text-justify'>
        ...
        <p className='text-2xl text-center'>
          Ancestry Terms and Conditions<br/>
        </p>
        <p>
          Summary of Changes<br/>
          This summary is intended to help you better understand recent changes to Ancestry’s Terms and how the changes may impact you. We encourage you to review the Terms in their entirety, along with the Privacy Statement.<br/>
          ...
          Improving legibility and otherwise simplifying the Terms<br/>
        ...
        <p>
          ...
          Please be aware that these Terms incorporate by reference additional policies and guidelines, including the Community Rules, Cookie Policy, Copyright Policy, Renewal and Cancellation Terms,  as well as our Privacy Statement, which explains how we collect and use your personal data. We encourage you to read all of these documents carefully to understand your rights and responsibilities when using the Services.
          ...
          Not to use the information obtained from the DNA Services (including any downloaded DNA Data (defined in the Privacy Statement)) in whole, in part, and/or in combination with any other database, for any medical, diagnostic, or paternity testing purpose, in any judicial proceeding, or for any discriminatory purpose or illegal activity.<br/>
        ...
        <p>
          ...
          Not to remove any copyright or other proprietary notices on any Ancestry Content;<br/>
        ...
        <p>
          ...
          Your Content will not include a living person without their consent. In the case of living minors, you will get consent from their parent or guardian;
          All Your Content will comply with the Community Rules;
          If you share Your Content publicly, other users may access and use Your Content as part of, or in conjunction with, the Services. We are not required to remove any of Your Content once it has been publicly shared.<br/>
