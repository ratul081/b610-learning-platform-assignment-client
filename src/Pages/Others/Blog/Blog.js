    ...
    <div className='min-h-screen lg:m-12 m-8 space-y-6'>
      ...
      <div className='lg:m-12 m-4'>
        <ol className='space-y-6'>
          <li>
            <p className='lg:text-3xl md:text-2xl text-xl mb-3 font-semibold'>1. What is cors?</p>
          ...
          <li>
            <p className='lg:text-3xl md:text-2xl text-xl mb-3 font-semibold'>2 Why are you using firebase? What other options do you have to implement authentication?
            </p>
          ...
          <li>
            <p className='lg:text-3xl md:text-2xl text-xl mb-3 font-semibold'>3. How does the private route work?</p>
            <p className='lg:text-lg text-sm'>
              <span className="font-semibold">Answer: </span>
          ...
          <li>
            <p className='lg:text-3xl md:text-2xl text-xl mb-3 font-semibold'>4. What is Node? How does Node work?</p>
            <p className='lg:text-lg text-sm'>
              <span className="font-semibold">Answer: </span>
